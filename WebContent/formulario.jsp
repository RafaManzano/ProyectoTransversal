...
<form>
  <div class="form-row">
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control" id="validationDefault01" placeholder="Nombre" value="nombre" required>
    </div>
    <div class="col-md-4 mb-3">
      <label for="validationDefault02">Apellidos</label>
      <input type="text" class="form-control" id="validationDefault02" placeholder="Apellidos" value="apellido" required>
    </div>
    <div class="col-md-4 mb-3">
  ...
  <div class="form-row">
    ...
    <div class="col-md-3 mb-3">
      ...
      <input type="text" class="form-control" id="validationDefault05" placeholder="codigo postal" required>
    </div>
  </div>
